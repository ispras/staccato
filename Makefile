...
CUDD_INC = $(CUDD_PATH)/include

ifeq ($(BUILD_TYPE), static)
	CFLAGS	= -c -O3 -funroll-all-loops -I$(CUDD_INC)
else
	CFLAGS	= -c -O3 -funroll-all-loops -fPIC -I$(CUDD_INC)
endif
...
test:
	...
	$(UTIL_LIB) $(DSD_LIB) -lcudd -ldsd -I$(CUDD_INC) -o sample
